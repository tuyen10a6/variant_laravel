...
<table class="table table-striped table-bordered" >
    ...
    @foreach($products as $product)
        <tr style="text-align: center">
            ...
            <td style="line-height: 5;">{{ $product->name }}</td>
            <td style="line-height: 5;"> <img style="width: 100px; height: 100px" src="{{ $product->product_image->path }}"/> </td>
            <td style="line-height: 5;">{{ number_format($product->price) }} đ</td>
            <td style="line-height: 5;">{{ $product->category->name }}</td>
            <td style="line-height: 5;">{{ $product->brand->name }}</td>

            <td  style="line-height: 6.2; display: flex; flex-wrap: wrap   ">
                <a href="{{route('admin.product.update', $product->id)}}"  style="margin-right:20px;text-decoration:none" >
                ...
                <a onclick="return confirm('Bạn có muốn xóa sản phẩm trên không?')" style="margin-right: 20px">
              ...
              <button style="background: none; border: none" type="submit">
               <svg  xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M135.2 17.7L128 32H32C14.3 32 0 46.3 0 64S14.3 96 32 96H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320l-7.2-14.3C307.4 6.8 296.3 0 284.2 0H163.8c-12.1 0-23.2 6.8-28.6 17.7zM416 128H32L53.2 467c1.6 25.3 22.6 45 47.9 45H346.9c25.3 0 46.3-19.7 47.9-45L416 128z"/></svg>
                ...
                <a   href="{{route('admin.product.show', $product->id)}}"  style="text-decoration:none" >
                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/></svg>
                </a>
                <a href="{{route('admin.variant.getvariant', $product->id)}}" class="ml-3" style="text-decoration:none">
