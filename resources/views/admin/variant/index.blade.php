...
@section('content')
    <h2 class="ml-3 mt-3 mb-3">Các biến thể</h2>
    <a href="{{route('admin.variant.create', $product->id)}}"  class="btn btn-danger ml-3 mb-3">
        Thêm mới
    </a>
        ...
        @foreach($variants as $item)
            <tr>
                ...
                <td  style=" display: flex; flex-wrap: wrap">
                    ...
                    <a href="" class="ml-3" style="text-decoration:none">
